...
namespace RvLinkDeviceTester.iOS
{
    ...
    public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
    {
        ...
        public override bool FinishedLaunching(UIApplication app, NSDictionary options)
        {
            ...
            BleImplementation.UseRestorationIdentifier("BLE Device Tester");  //Set support for iOS BLE State restoration
            ...
            IDS.Portable.Notifications.Platforms.iOS.PlatformInitializer.Init();
        ...
        private void SetupSerilog()
        {
            try
            {
                ...
                Log.Logger = new LoggerConfiguration()
                    ...
                    .WriteTo.LogViewerRealTimeEventSink()
                    .CreateLogger();
            }
            catch (Exception ex)
            {
