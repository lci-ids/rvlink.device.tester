...
namespace RvLinkDeviceTester.Connections.Sensors
{
    ...
    public class SensorConnectionBatteryMonitor : SensorConnectionBleBase<SensorConnectionBatteryMonitor>
    {
        [JsonProperty]
        ...
        [JsonConstructor]
        public SensorConnectionBatteryMonitor(string connectionNameFriendly, Guid connectionGuid, MAC accessoryMac, string softwarePartNumber) : base(connectionGuid)
        {
        ...
        //
        static SensorConnectionBatteryMonitor()  // static initializer
        {
