...
namespace RvLinkDeviceTester.Connections.Sensors
{
    ...
    public class SensorConnectionGeneric : SensorConnectionBleBase<SensorConnectionBatteryMonitor>
    {
        [JsonProperty]
        ...
        [JsonConstructor]
        public SensorConnectionGeneric(string connectionNameFriendly, Guid connectionGuid, MAC accessoryMac, string softwarePartNumber) : base(connectionGuid)
        {
        ...
        //
        static SensorConnectionGeneric()  // static initializer
        {
